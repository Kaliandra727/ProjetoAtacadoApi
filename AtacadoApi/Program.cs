...
builder.Services.AddSwaggerGen(options =>
    {
        options.SwaggerDoc("v1", new OpenApiInfo()
        {
            ...
            TermsOfService = new Uri("https://www.psgtecnologia.com.br"),
            Contact = new OpenApiContact()
            {
                Name = "Kaliandra de Freitas Pereira",
                Email = "kfreitaspereira1@gmail.com"
            },
            License = new OpenApiLicense()
            {
                Name = "PSG Tecnologia - Todos os direitos reservados.",
                Url = new Uri("https://www.psgtecnologia.com.br")
            }
        });
